...
test('nums', function (t) {
    ...
    t.same(typeof argv.left, 'number');
    t.same(typeof argv.top, 'number');
...
test('boolean groups', function (t) {
    var parse = optimist([ '-left', '-z', 'one', 'two', 'three' ])
        .boolean(['left','top','z']).argv;
    ...
    t.same(typeof parse.left, 'boolean');
    t.same(typeof parse.top, 'boolean');
...
test('strings' , function (t) {
    ...
    var x = optimist([ '-left', '56' ]).string('x').argv.left;
    t.same(x, '56');
...
test('slashBreak', function (t) {
    ...
    t.same(
        ...
        { left : true, top : true, z : '/foo/bar/baz', _ : [], $0 : $0 }
    );
    t.end();
});
